        ...
        for d_i in range(Distance):
            ...
            for r in Rlist:
                ...
                if r == 533945774 and t in (15,16):
                    ...
                    plot_matrices_in_computing(d_i, t, tmp_dict["x"], Win, W, x, tmp_dict["u"], u, 1/(10**expIndex), save_folder='./debug_fig13_2/')
                    plot_matrices(d_i, t, x, Win, W, Wout, tmp_dict["u"]/(10**expIndex), u/(10**expIndex), save_folder='./debug_fig13_1/')
                    if (t,d_i) == (15, 11):
                        print((t,d_i))
                        print("end")
                        return
